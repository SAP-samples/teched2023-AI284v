# Exercise 4 - Process a receipt using Document Information Extraction and LLMs (Large Language Models)
...
4. Drop the file directly or click **+** to upload the [receipt](https://github.com/SAP-samples/teched2023-AI284v/blob/main/exercises/ex4/files/receipt.jpg) sample document.
